...
export const Missing = ({ color }: { color: string }) => {
  return (
    ...
    >
      ...
      <motion.g
        id="g677"
        initial={{ scale: 1.05, y: -60 }}
        animate={{ scale: 0.95, y: 10, rotateZ: -5 }}
        transition={{
          duration: 2,
          repeat: Infinity,
          ease: 'easeInOut',
      ...
      <motion.g
        id="g703"
        initial={{ y: -40 }}
        animate={{ y: 10, rotateZ: 20, rotateY: 45 }}
        transition={{
          duration: 2,
          repeat: Infinity,
          ease: 'easeInOut',
      ...
      <motion.g
        id="g690"
        initial={{ y: -30, opacity: 0.1, rotateZ: 0 }}
        animate={{ y: 40, opacity: 1, scale: 1.05, rotateZ: -10 }}
        transition={{
          duration: 2,
          repeat: Infinity,
          ease: 'easeInOut',
      ...
      <motion.g
        id="g716"
        initial={{ x: -50, rotateZ: -4 }}
        animate={{ x: 50, rotateZ: 10 }}
        transition={{
          duration: 2,
          repeat: Infinity,
          ease: 'easeInOut',
      ...
      >
        ...
        <circle
          ...
          id="circle174"
        />
        <circle cx="542" cy="697.39398" r="6" fill="#fff" id="circle176" />
      </motion.g>
      <path
